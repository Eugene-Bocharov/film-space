...
// part_of_creating Sin_F

// setTimeout(() => {
//   const current_film = document.querySelectorAll('.poster_card');

// console.log(current_film);

// current_film.addEventListener('click', (event) => {console.log(44);})
// }, 438);

  const current_film = document.getElementsByTagName('ul');
  console.log(current_film);